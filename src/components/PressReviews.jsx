...
export default function PressReviews(){
    return(
        <div className="press-reviews" id='press' style={{display: "grid"}}>
            ...
            <div>
                <img style={{width: "45%", height: "25%", marginRight: "500px"}} src={"/cropped_images/infatuation.png"} alt="infatuation" />
            ...
            <div>
                <img style={{width: "25%", height: "25%", marginRight: "500px"}} src={"/cropped_images/time-out-logo-png-1.png"} alt="time-out" />
                <p style={{marginLeft: "500px", color: "white"}}>
            ...
            <div>
                <img style={{width: "25%", height: "25%", marginRight: "500px"}} src={"/cropped_images/Thrillist.png"} alt="thrillist" />
                <p style={{marginLeft: "500px", color: "white"}}>
